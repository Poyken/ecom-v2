...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(shared_1.CreateBrandSchema)),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('OWNER', 'ADMIN'),
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(shared_1.UpdateBrandSchema)),
    __param(0, (0, common_1.Param)('id')),
